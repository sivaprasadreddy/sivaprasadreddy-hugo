...
date = "2019-05-26"
draft = false
title = "From \"OMG, I don't have enough time\" to \"I am getting bored\""
type = "post"
images = ["/images/music-1.jpg"]
categories = [ "Thoughts", ]
tags = [ "Thoughts"]
thumbnail = "static/images/music-1.jpg"
+++
...
![Exhausted](/images/sleeping-1.jpg)
...
I am very confident that, I am capable of learning Azure with in the given timeframe if I need to use Azure.
So, Learn Azure is out of list.
...
As someone already rightfully said, **maturity is keeping your mouth shut when nobody ask you for a suggestion**.
I guess I am a little bit matured now and correcting someone on the internet is none of my business.
...
**Quit Social media:**
After careful observation I realized that the main cause of my TodoList pressure came from social media. I never really liked Facebook and LinkedIn but have been using Twitter regularly.
